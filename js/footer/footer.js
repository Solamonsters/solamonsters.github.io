var variable = '' +
  ...
  '    <h1 class="footerTitle">The Solamonsters Society</h1>' +
  '    <a href="/" class="logo"' +
  '      ><img' +
  '        src="assets/solamonsters-logo.png"' +
  '        width="15%"' +
  '        height="auto"' +
  '        style="border-radius: 70%; padding: 0"' +
  '    /></a>' +
  '  </div>' +
  '  <div class="footerDivider"></div>' +
  '' +
  '  <div class="footerSection" style="display:block">' +
  '    <a href="" class="footerText" style="padding: 5% 0; width: fit-content"' +
  '      >Back to top</a' +
  '    >' +
  '    <div>' +
  '    <a' +
  ...
  '            >Marketplace</a' +
  '          >' +
  '          <a href="collection" class="footerText">NFT Gallery</a> -->' +
  '  </div>' +
  '</div>' +
...
// <div class="footer">
//   <div class="footerSection">
//     <h1 class="footerTitle">Solamonsters Society</h1>
//     <a href="/" class="logo"
//       ><img
//         src="assets/solamonsters-logo.png"
//         width="15%"
