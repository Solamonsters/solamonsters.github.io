(function (h) {
    ...
    function Fa(a) {
        ...
        !a.sEmptyTable &&
            c &&
            "No NFT data available" === b.sEmptyTable &&
    ...
    function Ib(a, b) {
        for (
            var c, d = -1, e = -1, f = 0, g = a.aoData.length;
            f < g;
            f++
        )
            (c = B(a, f, b, "display") + ""),
    ...
    u("rows().ids()", "row().id()", function (a) {
        for (
            var b = [], c = this.context, d = 0, e = c.length;
            d < e;
            d++
        )
    ...
    m.defaults = {
        ...
        oLanguage: {
            ...
            sEmptyTable: "No NFT data available",
